...
// This indirection is to prevent visual studio from selecting ciel and floor from chrono in Release mode on Windows
static inline double _ceil(double val) { return ceil(val); }
static inline double _floor(double val) { return floor(val); }
