...
constexpr vec4 COLOR_WHITE = {1, 1, 1, 1};
constexpr vec4 COLOR_BLACK = {0, 0, 0, 1};
constexpr vec4 COLOR_RED = {1, 0, 0, 1};
constexpr vec4 COLOR_GREEN = {0, 1, 0, 1};
constexpr vec4 COLOR_BLUE = {0, 0, 1, 1};
constexpr vec4 COLOR_YELLOW = {1, 1, 0, 1};
constexpr vec4 COLOR_MAGENTA = {1, 0, 1, 1};
constexpr vec4 COLOR_CYAN = {0, 1, 1, 1};
...
constexpr Material MATERIAL_GLOSSY_WHITE = {COLOR_WHITE, {0.04f, 0.04f, 0.04f}, 0.5};
constexpr Material MATERIAL_GLOSSY_BLACK = {COLOR_BLACK, {0.04f, 0.04f, 0.04f}, 0.5};
constexpr Material MATERIAL_GLOSSY_RED = {COLOR_RED, {0.04f, 0.04f, 0.04f}, 0.5};
constexpr Material MATERIAL_GLOSSY_GREEN = {COLOR_GREEN, {0.04f, 0.04f, 0.04f}, 0.5};
constexpr Material MATERIAL_GLOSSY_BLUE = {COLOR_BLUE, {0.04f, 0.04f, 0.04f}, 0.5};
constexpr Material MATERIAL_GLOSSY_YELLOW = {COLOR_YELLOW, {0.04f, 0.04f, 0.04f}, 0.5};
constexpr Material MATERIAL_GLOSSY_MAGENTA = {COLOR_MAGENTA, {0.04f, 0.04f, 0.04f}, 0.5};
constexpr Material MATERIAL_GLOSSY_CYAN = {COLOR_CYAN, {0.04f, 0.04f, 0.04f}, 0.5};
